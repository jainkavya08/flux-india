...
export default function PanelBuildingPage() {
  ...
  const filteredProducts = useMemo(() => {
    return PANEL_BUILDING_PRODUCTS.filter((prod) => {
      const matchesCat =
  ...
  return (
    <div className="min-h-screen bg-[#f4f7fa] pb-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white text-[#1a56b0] text-xs font-bold uppercase tracking-widest mb-4 border border-[#bcdbf7] shadow-xs">
              ...
              <span>Catalog &bull; Category 01</span>
            </div>
            ...
            <p className="mt-4 text-base sm:text-lg text-slate-700 leading-relaxed">
              High-quality, type-tested components for reliable, safe, and efficient control panels and power distribution switchboards. Sourced directly from premier OEM partners.
            </p>
        ...
        <div className="bg-white rounded-2xl shadow-card border border-slate-200 p-4 sm:p-5 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="relative w-full md:w-96">
            ...
            <input
              ...
              placeholder="Search ACB, MCCB, contactors, Rittal, Siemens..."
          ...
          <div className="text-xs font-semibold text-slate-500 flex items-center gap-2">
            ...
            <span>Showing {filteredProducts.length} verified product lines</span>
          </div>
        </div>
            ...
            >
              <div>
                ...
                <div className="mt-4 pt-3 border-t border-slate-100 flex flex-wrap items-center gap-1 text-[11px] text-slate-500">
                  <span className="font-semibold text-slate-700">OEM Partners:</span>
          ...
          <div className="space-y-6 text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-3.5 bg-blue-50/60 rounded-xl border border-blue-100">
                <h5 className="text-xs font-bold text-[#0d2b4e] mb-1.5">Common Applications</h5>
              ...
              <div className="p-3.5 bg-blue-50/60 rounded-xl border border-blue-100">
                <h5 className="text-xs font-bold text-[#0d2b4e] mb-1.5">Authorized OEM Brands</h5>
                ...
                <div className="mt-2 text-[11px] text-emerald-700 font-semibold flex items-center gap-1">
                  ...
                  <span>With Manufacturer Test Certificate</span>
                </div>
              </div>
            </div>
      ...
      <Modal
        ...
        title="Panel Building BOM Quotation"
        subtitle="Submit your component list or upload your single-line diagram (SLD)."
        maxWidth="lg"
      >
        <BOMUploadForm
          defaultProjectType="Panel Building & Switchgear"
